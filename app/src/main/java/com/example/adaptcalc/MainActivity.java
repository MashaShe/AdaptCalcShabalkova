...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btChangeToUsual = findViewById(R.id.buttonUsual);
        final Button btChangeToEng = findViewById(R.id.buttonEng);
        final LinearLayout engLayout = findViewById(R.id.EngLayout);
        final LinearLayout usualLayout = findViewById(R.id.nonEngLayout);

        btChangeToEng.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btChangeToUsual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
